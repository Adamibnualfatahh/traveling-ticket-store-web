                  ...
                  <div class="features row">
                    <div class="col-md-4 ">
                      <div class="description">
                        <img src=" {{url('frontend/images/t.png')}}"
                              alt="" 
                      ...
                      <div class="col-md-4 border-left">
                        <div class="description ">
                          <img src="{{ url('frontend/images/r.png')}}" alt="" class="features-image">
                          <div class="description">
                            <h3>
                              languange
                            </h3>
                        ...
                        <div class="col-md-4 border-left">
                          <div class="description">
                            <img src="{{ url('frontend/images/q.png')}}" alt="" class="features-image">
                           <div class="description">
                            <h3>
                              Foods
                          </h3>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="member my-2">
                ...
                <img src="{{url('frontend/images/members.png')}}"class="member-image mr-1">
                <img src="{{url('frontend/images/members.png')}}"class="member-image mr-1">
                <img src="{{url('frontend/images/Group 34.pn')}}g"class="member-image mr-1">
              </div>
              <hr>
