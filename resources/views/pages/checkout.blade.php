          ...
          <div class="row">
                  ...
                  <div class="card card-details">
                                      ...
                                      <tr>
                                          ...
                                          <td class="align-middle">
                                              <a href="{{ route('checkout-remove', $detail->id) }}">
                                                  <img src="{{ url('frontend/images/delete.png') }}" alt="">
                                              </a>
                                          </td>
                                      </tr>
                                  @empty
                      ...
                      <div class="member mt-3">
                          ...
                          <form class="form-inline" method="POST" action="{{route('checkout-create', $item->id)}}">
                              ...
                              <input type="text" 
                              name="nationality" 
                              class="form-control mb-2 mr-sm-2" id="nationality" 
                              required
                              style="width: 50px" 
            ...
            <p class="payment-instructions">Please complete the payment before you
              ...
              <div class="bank-item pb-3">
                <img src="{{ url('frontend/images/Group 33.png')}}" alt="" class="bank-image">
              ...
              <div class="bank-item pb-3">
                <img src="{{ url('frontend/images/Group 33.png')}}" class="bank-image"alt="">
                <div class="description">
                  <h3>PT Santri Letter</h3>
                  <p>
                   0851 0082 3761
                  </p>
                  <p>Bank Central Asia</p>
            ...
            <div class="join-container">
              <a href="{{ url('checkout/confirm', $item->id) }}" class="btn btn-block btn-join-now mt-3 py-2">
                I Have Made Payment
            </a>
        </div>
